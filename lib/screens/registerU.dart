...
class RegistrationScreenU extends StatefulWidget {
  static const String screenRoute = 'registerU';
  const RegistrationScreenU({Key? key}) : super(key: key);

  @override
  _RegistrationScreenUState createState() => _RegistrationScreenUState();
}

class _RegistrationScreenUState extends State<RegistrationScreenU> {
